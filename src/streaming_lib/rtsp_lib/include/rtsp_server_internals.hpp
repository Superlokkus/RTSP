...
private:
    ...
    std::unordered_map<rtsp::session_identifier, rtsp::rtsp_server_session> sessions_;
     ...
     */
    void delete_session(std::unordered_map<rtsp::session_identifier, rtsp::rtsp_server_session>::iterator &session_it);
};
