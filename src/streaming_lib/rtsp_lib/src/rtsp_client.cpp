...
rtsp::rtsp_client::rtsp_client(std::string url, std::function<void(std::exception &)> error_handler,
...
void rtsp::rtsp_client::set_new_jpeg_frame_callback(std::function<void(rtsp::rtsp_client::jpeg_frame)> frame_handler) {
